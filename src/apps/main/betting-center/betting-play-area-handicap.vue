      ...
      <div class="body">
        <div class="main">
          <div class="main-row" v-for="rowItem in rule.items">
            ...
            <!--根据是否存在子项进行区别渲染-->
            <div class="main-item" v-for="item in rowItem" v-if="item.row" :class="{selected: item.selected}" v-ripple="'rgba(216, 137, 45, .5)'"
                 @click="select(item)">
            ...
            <div class="main-item" v-else :class="{selected: item.selected, empty: _.isEmpty(item)}" v-ripple="'rgba(216, 137, 45, .5)'"
                 @click="select(item)">
